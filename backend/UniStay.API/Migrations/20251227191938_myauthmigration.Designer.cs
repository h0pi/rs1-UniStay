...
namespace UniStay.API.Migrations
{
    ...
    [Migration("20251227191938_myauthmigration")]
    partial class myauthmigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackupCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TwoFactorCode", b =>
                {
                    ...
                    b.ToTable("TwoFactorCode");
                });

            modelBuilder.Entity("TwoFactorSettings", b =>
                {
                    b.Property<int>("UserID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniStay.API.Data.Models.MyAuthInfo", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MyAuthInfo");
                });

            modelBuilder.Entity("UniStay.API.Data.Models.MyAuthenticationToken", b =>
                {
            ...
            modelBuilder.Entity("UserSecurityAnswer", b =>
                {
                    b.Property<int>("UserSecurityAnswerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserSecurityAnswerID"));
            ...
            modelBuilder.Entity("PasswordResetToken", b =>
                {
                    b.HasOne("UniStay.API.Data.Models.Users", "User")
                        .WithMany()
